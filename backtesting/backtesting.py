...
class Trade:
    ...
    def pl(self):
        ...
        commission = (
            self.__broker._commission
            if self.__broker._commission_type == "absolute"
            else 0
        )
        # Change by AT
        ...
        return (
            self.__size
            * (price - self.__entry_price)
            * (self.__broker._features_coeff * 10 or 1)
            - commission
        )
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(commission_type, str):
            raise TypeError(
                "`commission_type` must be a str value (percent or absolute)"
            )
