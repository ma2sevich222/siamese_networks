...
from other_codes.old_project.old_utilits.functions_for_train_nn import get_locals
from utilits.visualisation_functios import (
    calculate_cos_dist,
    pattern_samples_plot,
...
patterns_file_name = "buy_patterns_extr_window60_latent_dim5_pattern_size15.csv"
results_file_name = "test_results_extr_window60_latent_dim5_pattern_size15.csv"
...
patterns = loader.reshape(
    -1, PATTERN_SIZE, len(Eval_df.columns.to_list())
)  # возвращаем исходный размер
neighbor_patterns = calculate_cos_dist(
    patterns, pattern_num
)  # ближайшие соседи паттерна
